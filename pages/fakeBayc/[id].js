...
export default function FakeBaycIndex() {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (contract && routeId) {
        ...
        fetch(_baseURI + routeId).then(res => res.json()).then((json) => {
          setImageBaseURI("http://ipfs.io/" + json.image.split("://").join("/"));
        ...
        { accounts && !loading && accounts.length > 0 && (
          <>
            <div className={styles.titleContainer}>
              <a href={`/fakeBayc`}><button className='back'>Back</button></a>
              <h1>{tokenName}</h1>
            </div>
            <div className={styles.gallery}>
              <div className={styles.galleryItem}>
                <img src={imageBaseURI} style={{maxWidth: "unset"}}></img>
              </div>
            </div>
          </>
        )}
